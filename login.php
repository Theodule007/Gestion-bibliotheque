...
<html lang="en">
  <head>
    ...
    <title>connecter pour acceder a la bibliotheque</title>
    <!-- plugins:css -->
          ...
          <div class="row w-100">
            <div class="col-lg-4 mx-auto">
              <div class="auto-form-wrapper">
                <form action="functions\authentication.php" class="container" method="POST">
                  <div class="form-group">
                    <label class="label">Username or email</label>
                    <div class="input-group">
                      <input type="text" class="form-control" placeholder="Username ou email" name="email" required>
                  ...
                  <div class="form-group">
                    <button class="btn btn-primary submit-btn btn-block" name="connectbutton" type="submit">Login</button>
                  </div>
