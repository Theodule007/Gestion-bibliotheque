...
<html lang="en">
  <head>
    ...
    <title>Dashboard Bibliothecaire</title>
    <!-- plugins:css -->
      ...
      <div class="container-fluid page-body-wrapper">
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
          <ul class="nav">
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  ...
                  <p class="designation">Bibliothecnaire</p>
                </div>
              </a>
            </li>
            <li class="nav-item nav-category">Main Menu</li>
            <li class="nav-item">
              <a class="nav-link" href="./dashboard_bibliothecaire.php">
            ...
            <li class="nav-item">
              <a class="nav-link" href="./gestion_livre">
                <i class="menu-icon typcn typcn-shopping-bag"></i>
                <span class="menu-title">Catalogues livres</span>
              </a>
            </li>
            <li class="nav-item">
              ...
              <div class="col-lg-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body" style="height:100px;overflow:auto">
                    ...
                    <p class="card-description"> Info sur les livres de la bibliotheque </p>
                      ...
                      <?php foreach($search_result_pret as $pret){ 
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            $progress_percent=floor(($jour*100)/22);
                            ?>
                            <div class="progress">
